...
public class TonePurple extends AbstractPower {
    public static final String POWER_ID = NameAssist.MakePath("TonePurple");
    // 能力的本地化字段
    ...
    public TonePurple(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
