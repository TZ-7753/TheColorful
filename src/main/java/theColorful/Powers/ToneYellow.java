...
public class ToneYellow extends AbstractPower{

    // 能力的ID
    public static final String POWER_ID = NameAssist.MakePath("ToneYellow");
    // 能力的本地化字段
    ...
    public ToneYellow(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
