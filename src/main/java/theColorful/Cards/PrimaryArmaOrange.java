...
public class PrimaryArmaOrange extends ToningCards {
    public static final String ID = NameAssist.MakePath("PrimaryArmaOrange");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "TC_resources/img/cards/PrimaryArmaOrange.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractCard card1 = new SunriseVariine();
        AbstractCard card2 = new MeridiemChords();
        AbstractCard card3 = new SunsetSonata();
        if(this.upgraded){
            card1.upgrade();
            card2.upgrade();
            card3.upgrade();
