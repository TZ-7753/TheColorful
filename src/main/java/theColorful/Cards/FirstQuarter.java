...
public class FirstQuarter extends ToningCards {
    public static final String ID = NameAssist.MakePath("FirstQuarter");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    //private static final String NAME = "打击";
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "TC_resources/img/cards/FirstQuarter.png";
    ...
    public FirstQuarter() {
        ...
        this.exhaust = true;
        this.cardsToPreview = new LastQuarter_D();
    }
    ...
    public void upgrade() {
        if (!this.upgraded) {
            ...
            AbstractCard c1 = new LastQuarter_D();
            c1.upgrade();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractCard c2 = new LastQuarter();
