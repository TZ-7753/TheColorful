...
public class PrimaryArmaYellow extends ToningCards {
    public static final String ID = NameAssist.MakePath("PrimaryArmaYellow");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "TC_resources/img/cards/PrimaryArmaYellow.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractCard card1 = new MirageDoppel();
        AbstractCard card2 = new MirageCity();
        AbstractCard card3 = new GoldenSpear();
        if(this.upgraded){
            card1.upgrade();
            card2.upgrade();
            card3.upgrade();
